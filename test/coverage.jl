...
State 1
  ...
  5: («input_value» isa Tuple && length(«input_value») && «length(input_value)» >= 2 && «input_value»[-1] && (e).q1 && where «where_0») => «input_value[-1]»
  6: («input_value» == 6 || «input_value» == 7) => 6
  7: («input_value» isa Main.Rematch2Tests.A && (e).q2 && where «where_1») => 7
  8: («input_value» isa Main.Rematch2Tests.B && (e).q3 && where «where_2») => 8
  9: («input_value» isa Main.Rematch2Tests.C && (e).q4 && where «where_3») => 9
  10: («input_value» isa Main.Rematch2Tests.Foo && «input_value».x && «input_value».y && «input_value.y» == 2 && (f1)(«input_value.x») && where «where_4») => 1
  11: («input_value» isa Main.Rematch2Tests.Foo && «input_value».x && «input_value.x» == 1 && «input_value».y && (f2)(«input_value.y») && where «where_5») => 2
  12: («input_value» isa Main.Rematch2Tests.Foo && «input_value».x && «input_value».y && (f1)(«input_value.x») && where «where_4» && (f2)(«input_value.y») && where «where_5») => 3
    TEST «input_value» == 1
...
State 4
  ...
  6: («input_value» == 6 || «input_value» == 7) => 6
  10: («input_value».x && «input_value».y && «input_value.y» == 2 && (f1)(«input_value.x») && where «where_4») => 1
  11: («input_value».x && «input_value.x» == 1 && «input_value».y && (f2)(«input_value.y») && where «where_5») => 2
  12: («input_value».x && «input_value».y && (f1)(«input_value.x») && where «where_4» && (f2)(«input_value.y») && where «where_5») => 3
    FETCH «input_value.x» := «input_value».x
    NEXT: State 5 (fall through)
State 5
  2: («input_value».y && «input_value.y» == «input_value.x») => 2
  6: («input_value» == 6 || «input_value» == 7) => 6
  10: («input_value».y && «input_value.y» == 2 && (f1)(«input_value.x») && where «where_4») => 1
  11: («input_value.x» == 1 && «input_value».y && (f2)(«input_value.y») && where «where_5») => 2
  12: («input_value».y && (f1)(«input_value.x») && where «where_4» && (f2)(«input_value.y») && where «where_5») => 3
    FETCH «input_value.y» := «input_value».y
    NEXT: State 6 (fall through)
State 6
  2: «input_value.y» == «input_value.x» => 2
  6: («input_value» == 6 || «input_value» == 7) => 6
  10: («input_value.y» == 2 && (f1)(«input_value.x») && where «where_4») => 1
  11: («input_value.x» == 1 && (f2)(«input_value.y») && where «where_5») => 2
  12: ((f1)(«input_value.x») && where «where_4» && (f2)(«input_value.y») && where «where_5») => 3
...
State 10
  ...
  12: ((f1)(«input_value.x») && where «where_4» && (f2)(«input_value.y») && where «where_5») => 3
    ...
    ELSE: State 17
State 11
  10: ((f1)(«input_value.x») && where «where_4») => 1
  11: («input_value.x» == 1 && (f2)(«input_value.y») && where «where_5») => 2
  12: ((f1)(«input_value.x») && where «where_4» && (f2)(«input_value.y») && where «where_5») => 3
...
State 12
  10: where «where_4» => 1
  11: («input_value.x» == 1 && (f2)(«input_value.y») && where «where_5») => 2
  12: (where «where_4» && (f2)(«input_value.y») && where «where_5») => 3
    TEST where «where_4»
...
State 14
  11: («input_value.x» == 1 && (f2)(«input_value.y») && where «where_5») => 2
    ...
    ELSE: State 57
State 15
  11: ((f2)(«input_value.y») && where «where_5») => 2
...
State 19
  11: where «where_5» => 2
  12: ((f1)(«input_value.x») && where «where_4» && where «where_5») => 3
    TEST where «where_5»
...
State 22
  12: (where «where_4» && (f2)(«input_value.y») && where «where_5») => 3
    ...
    ELSE: State 57
State 23
  12: ((f2)(«input_value.y») && where «where_5») => 3
    FETCH «where_5» := (f2)(«input_value.y»)
...
State 33
  ...
  9: («input_value» isa Main.Rematch2Tests.C && (e).q4 && where «where_3») => 9
    ...
    ELSE: State 42
State 34
  5: (length(«input_value») && «length(input_value)» >= 2 && «input_value»[-1] && (e).q1 && where «where_0») => «input_value[-1]»
  6: («input_value» == 6 || «input_value» == 7) => 6
    FETCH «length(input_value)» := length(«input_value»)
    NEXT: State 35 (fall through)
State 35
  5: («length(input_value)» >= 2 && «input_value»[-1] && (e).q1 && where «where_0») => «input_value[-1]»
  6: («input_value» == 6 || «input_value» == 7) => 6
    TEST «length(input_value)» >= 2
    THEN: State 36 (fall through)
    ELSE: State 40
State 36
  5: («input_value»[-1] && (e).q1 && where «where_0») => «input_value[-1]»
  6: («input_value» == 6 || «input_value» == 7) => 6
    FETCH «input_value[-1]» := «input_value»[-1]
    NEXT: State 37 (fall through)
State 37
  5: ((e).q1 && where «where_0») => «input_value[-1]»
  6: («input_value» == 6 || «input_value» == 7) => 6
    FETCH «where_0» := (e).q1
