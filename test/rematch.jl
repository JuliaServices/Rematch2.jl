...
@testset "Tests imported from Match.jl" begin
    ...
    # Type matching
    test1(item) = @__match__ item begin
    ...
    test2(person) = @__match__ person begin
    ...
    test_interp(item) = @__match__ item begin
        [a, b] => :($a + $b)
    end
